...
class MyWindow(object):
    ...
    def higSam(self, *args):
        ...
        cmds.setAttr("defaultArnoldRenderOptions.textureMaxMemoryMB", 409600)
    ...
    def RenderSetting(self, *args):
        ...
        cmds.setAttr('defaultRenderGlobals.imageFilePrefix',
                    r'W:\{}\renders\{}\{}\3d\lgt\<RenderLayer>\v001\<RenderPass>\{}_{}_{}_<RenderLayer>_<RenderPass>_v001'.format(FileDirSplit[1], FileDirSplit[2], FileDirSplit[3], FileDirSplit[1], FileDirSplit[2], FileDirSplit[3]),
                    type='string')
